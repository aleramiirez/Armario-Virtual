...
class GarmentService {
  ...
  Future<File> _processImage(File imageFile) async {
    ...
    final results = await callable.call<Map<String, dynamic>>({'imageBase64': imageBase64});
  ...
  Future<void> _saveGarmentData(String userId, String garmentName, String imageUrl) async {
    await _firestore
        .collection('users')
        .doc(userId)
        .collection('garments')
